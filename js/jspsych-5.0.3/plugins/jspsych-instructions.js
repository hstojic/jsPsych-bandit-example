...
jsPsych.plugins.instructions = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function show_current_page() {
      if (trial.urls) {
        display_element.load(trial.pages[current_page], function() {
        
          if (trial.show_clickable_nav) {

            var nav_html = "<div class='jspsych-instructions-nav'>";
            if (current_page != 0 && trial.allow_backward) {
              nav_html += "<button id='jspsych-instructions-back' class='btn btn-default'>Back</button>";
            }
            nav_html += "<button id='jspsych-instructions-next' class='btn btn-default'>Continue</button></div>"
        ...
        display_element.load(trial.pages[current_page]);
